...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/'); // Redirect to Home page after auth
    } catch (error) {
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-bold text-base gap-2 shadow-lg shadow-primary/20 transition-all hover:scale-[1.01] active:scale-[0.99] mt-2 disabled:opacity-60"
              >
